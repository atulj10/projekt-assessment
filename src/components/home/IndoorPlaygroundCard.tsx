...
const IndoorPlaygroundCard = () => {
  return (
    <div className="bg-[linear-gradient(180deg,_#0098A7_0%,_#00191B_100%)] rounded-xl p-6 pb-8 shadow-xl relative lg:col-start-2 lg:row-start-1 lg:row-span-3 h-full flex flex-col items-start justify-center">
      <div
